...
class Mice(Base):
    ...
    aplicable_type = Column(String(10), comment='适用类型')
    mice_size = Column(String(10), comment='鼠标大小')
    work_way = Column(String(10), comment='工作方式')
    connect_method = Column(String(10), comment='连接方式')
    mice_interface = Column(String(10), comment='鼠标接口')
    key_number = Column(String(10), comment='按键数')
    wheel_direction = Column(String(10), comment='滚轮方向')

    color = Column(String(30), comment='颜色')
    line_lenght = Column(String(10), comment='线长')
...
class Keyboard(Base):
    ...
    keyboard_layout = Column(String(20), comment='键盘布局')

    axis = Column(String(30), comment='轴')

    color = Column(String(30), comment='颜色')
    size = Column(String(30), comment='尺寸')
    weight = Column(String(20), comment='重量')
    supply_mode = Column(String(10), comment='供电模式')
...
class User(Base):
    ...
    id = Column(Integer, nullable=False, primary_key=True, comment='标识符')
    number = Column(String(15), nullable=False, unique=True, comment='账户')
...
class Collection(Base):
    ...
    number = Column(String(15), nullable=False,primary_key=True, comment='账户')
